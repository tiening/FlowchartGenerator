...
public class ConnectComponent {
     ...
     */
    public static int[] compactLabeling(int[] image, int width, int height, boolean zeroAsBg)
    {
        //label first
        int[] label= labeling(image, width, height, zeroAsBg);
     ...
     */
    public static int[] labeling(int[] image, int width, int height, boolean zeroAsBg)    
    {
    	int MAX_LABELS= 800000;
